...
import com.dzinemedia.ownerpropertyfyapp.databinding.SaleFragmentItemBinding
...
class SaleFragmentAdapter(
    val rentedList: ArrayList<Data>,
    val listener: SaleFragmentItemCallback
) :
    RecyclerView.Adapter<SaleFragmentAdapter.ViewHolder>() {

    class ViewHolder(val binding: SaleFragmentItemBinding) :
        RecyclerView.ViewHolder(binding.root) {
        fun bind(position: Int, listener: SaleFragmentItemCallback, ownerPropertyModel: Data) {
            binding.root.setOnClickListener(DebounceClickHandler {
                listener.saleFragmentItemClick(position, ownerPropertyModel)
            })
        }
    }
    ...
    override fun onCreateViewHolder(
        ...
        val binding: SaleFragmentItemBinding = DataBindingUtil.inflate(
            LayoutInflater.from(parent.context),
            R.layout.sale_fragment_item,
            parent,
            false
        )
