...
class AmenitiesChipAdapter (context: Context, private val chipGroup: ChipGroup, private val chipData: ArrayList<Any>) {
    ...
    fun displayInitialItems() {
        ...
        for (chipText in initialItems) {
            val chip = inflater.inflate(R.layout.fragment_info_amenities_item, chipGroup, false) as Chip
    ...
    private fun addMoreChip() {
        val moreChip = inflater.inflate(R.layout.more_fragment_info_amenities_item, chipGroup, false) as Chip
    ...
    private fun addShowLessChip() {
        val showLessChip = inflater.inflate(R.layout.more_fragment_info_amenities_item, chipGroup, false) as Chip
