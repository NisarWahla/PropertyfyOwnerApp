...
class OverviewTenantContractHistoryAdapter(
    val overviewArrayList: ArrayList<RentalPlanX>,
    val listener: OverviewOwnerTenantItemCallback
) :
    RecyclerView.Adapter<OverviewTenantContractHistoryAdapter.ViewHolder>() {

    class ViewHolder(val binding: RentalPaymentItemBinding) :
        RecyclerView.ViewHolder(binding.root) {
        fun bind(position: Int, rentalModel: RentalPlanX, listener: OverviewOwnerTenantItemCallback) {
            binding.root.setOnClickListener(DebounceClickHandler {
                listener.rentalHistoryItemClick(position, rentalModel)
            })
        }
    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val rentalModel = overviewArrayList[position]
        holder.binding.let {
            ...
            } else if (rentalModel.paymentMethod.equals("check", ignoreCase = true) || rentalModel.paymentMethod.equals("cheque", ignoreCase = true)) {
