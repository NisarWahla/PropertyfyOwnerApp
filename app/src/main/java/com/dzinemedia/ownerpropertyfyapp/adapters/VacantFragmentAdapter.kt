...
import com.dzinemedia.ownerpropertyfyapp.databinding.VacantFragmentItemBinding
...
class VacantFragmentAdapter(
    val dataList: ArrayList<Data>,
    val listener: VacantFragmentItemCallback
) :
    RecyclerView.Adapter<VacantFragmentAdapter.ViewHolder>() {

    class ViewHolder(val binding: VacantFragmentItemBinding) :
        RecyclerView.ViewHolder(binding.root) {
        fun bind(position: Int, listener: VacantFragmentItemCallback, ownerPropertyModel: Data) {
            binding.root.setOnClickListener(DebounceClickHandler {
                listener.vacantFragmentItemClick(position, ownerPropertyModel)
            })
        }
    }
    ...
    override fun onCreateViewHolder(
        ...
        val binding: VacantFragmentItemBinding = DataBindingUtil.inflate(
            LayoutInflater.from(parent.context),
            R.layout.vacant_fragment_item,
            parent,
            false
        )
